<%@ Page Title="" Language="C#" MasterPageFile="~/ClientMaster.master" AutoEventWireup="true" CodeFile="about.aspx.cs" Inherits="about" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
     <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <title>About Us | crocus travel - Travel Agency HTML Template</title>
    ...
    <section class="tour-cta">
        <div class="container">
            <div class="section-title text-center">
                ...
                <p class="heading_txt">There are variations available majoritaey suffered alteration words which look
                    believable</p>
            </div>
                ...
                <div class="row">
                        ...
                        <div class="choose-us-wrapper">
                            ...
                            <div class="single-choose-us">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                                    ...
                                    dolore magna enim ad minim. </p>
                            </div>


                            <div class="single-choose-us">
                                <h3 class="text-uppercase">Best Service Guarantee</h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                                    incididunt ut labore et
                                    dolore magna enim ad minim. </p>
                            </div>
                            ...
                            <div class="single-choose-us">
                                <h3 class="text-uppercase">We Are Trusted and Secured</h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                                    incididunt ut labore et
                                    dolore magna enim ad minim. </p>
                            </div>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="image-content">
                            <img src="images/flight/plane4.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
